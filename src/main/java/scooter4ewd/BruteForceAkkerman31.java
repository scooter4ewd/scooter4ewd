 ...
 * </p>
 * <p>Результат:</p>
 * <p>Вынос поворотного кулака назад:50.0 мм (относительно центра вращения колеса)</p>
 * <p>Вынос поворотного кулака во внутрь:0.0 мм (относительно центра вращения колеса в ширь)</p>
 * <p>Длина рулевой сошки:56.0</p>
 * <p>Ширина рулевой сошки:27.0</p>
 * <p>Погрешность:178.49949032972515</p>
 * <p>Time:229381ms</p>
 */
public class BruteForceAkkerman31 {
     ...
     * @param r1r2_y вынос поворотного кулака назад
    ...
    private static double test(
        ...
        for (double r_a = BruteForceConst.MIN_ANGLE; r_a <= BruteForceConst.MAX_ANGLE; r_a += BruteForceConst.STEP_ANGLE) {
            ...
            double cl1l2c2 = Trigonometry.angle(l2cl1, c2r2, cr1c2);

            double l_a_fact = l1l2cl1 + cl1l2c2 + a11 - 90;
