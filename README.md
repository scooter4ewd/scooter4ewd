...
## Как строить
1. Брус 25х100 нарезать по длине на 1250мм и 500мм, получаем детали центральный лонжерон ([№2](readme/part/02part.md)), передняя ось ([№3](readme/part/03part.md)).
...
1. Собираем основу рамы, на ровной поверхности выкладываем прямоугольник из передней оси ([№3](readme/part/03part.md)), лонжероны 2 шт ([№4](readme/part/04part.md)), задняя ось ([№5](readme/part/05part.md)), проверяем что углы прямые
...
1. TODO Нижняя втулка руля
1. TODO Верхняя втулка руля
1. TODO Верхняя втулка руля уголками
1. TODO Ось руля
1. TODO Вынос руля, руль
1. TODO Стул
1. TODO Педаль тормоза
1. TODO Трос тормоза
